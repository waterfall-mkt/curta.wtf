...
const H4: React.FC<JSX.IntrinsicElements['h4']> = ({ children, ...rest }) => {
  ...
  if (typeof children === 'string') {
    ...
    return (
      <h4 id={id} {...rest}>
        ...
        >
          {children}
          <Link className="hidden h-3 w-3 text-gray-200 animate-in fade-in-50 group-hover:flex group-focus-visible:flex" />
        </a>
      </h4>
    );
  }
