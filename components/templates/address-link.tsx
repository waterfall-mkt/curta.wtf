...
const AddressLink: FC<AddressLinkProps> = async ({
  ...
  return (
    <a
      className={twMerge(
        clsx(
          '-mx-0.5 line-clamp-1 text-ellipsis rounded-md px-0.5 text-gray-200 transition-colors hover:text-gray-100 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-250',
          className,
        ),
      )}
