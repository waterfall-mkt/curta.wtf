...
const CredentialFeature: FC<CredentialFeatureProps> = ({ href, name, description, children }) => {
  return (
    <Link
      className="group overflow-hidden rounded-xl border border-stroke bg-gray-600 no-underline transition-colors hover:border-gray-250 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-250"
      href={href}
    >
