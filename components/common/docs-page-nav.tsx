...
const DocsPageNav: FC<DocsPageNavProps> = ({ sections }) => {
  ...
  return (
    <div className="flex w-full items-center justify-between">
      {prevPage ? (
        <Link
          className="-mr-0.5 flex items-center space-x-1 rounded-sm pr-0.5 text-sm text-gray-200 no-underline transition-colors hover:text-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-250"
          href={prevPage.slug}
        >
      ...
      {nextPage ? (
        <Link
          className="-ml-0.5 flex items-center space-x-1 rounded-sm pl-0.5 text-sm text-gray-200 no-underline transition-colors hover:text-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-250"
          href={nextPage.slug}
        >
