...
const ErrorLayout: FC<ErrorLayoutProps> = ({ statusCode, children }) => {
  ...
  return (
    <div className="h-fill flex grow flex-col items-center justify-center">
      ...
      <a
        className="-mx-1 mt-2 rounded-md px-1 text-center font-mono text-sm font-book text-tw-red hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-250 lg:mt-4 lg:text-base"
