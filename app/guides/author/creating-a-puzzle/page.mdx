...
export const metadata = getBaseMetadata({
  ...
  description: 'Learn how to write, deploy, and add a puzzle to Curta.',
...
```solidity fileName='IPuzzle.sol' highlightLines={[4, 11, 18]}
interface IPuzzle {
...
## Using your Authorship Token

After obtaining an Authorship Token and deploying your puzzle, you can use it like a ticket to add a puzzle by calling `addPuzzle(IPuzzle _puzzle, uint256 _id)` on Curta:
