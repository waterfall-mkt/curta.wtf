...
After obtaining an Authorship Token and deploying your puzzle contract, you can use it like a ticket to add a puzzle by calling `addPuzzle(IPuzzle,uint256)` on [Curta contract](https://etherscan.io/address/0x0000000006bC8D9e5e9d436217B88De704a9F307#writeContract):
...
To set this onchain, call `setPuzzleColors(uint32,uint256)` on the [Curta contract](https://etherscan.io/address/0x0000000006bC8D9e5e9d436217B88De704a9F307#writeContract):
