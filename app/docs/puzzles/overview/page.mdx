...
To simplify, each puzzle's submission period lasts from the time it's added to 5 days after the first valid solution is submitted (aka **First Blood**).
