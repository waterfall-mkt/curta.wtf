...
A puzzle becomes available to solve by anyone as soon as an author adds it to the [Curta contract](https://etherscan.io/address/0x0000000006bC8D9e5e9d436217B88De704a9F307). When a player submits a valid submission, a [Flag](/docs/puzzles/submitting-solutions#flag-nfts) NFT is minted to the solver, and they earn [points](/docs/leaderboard), which is used to place them on the [leaderboard](/leaderboard).
