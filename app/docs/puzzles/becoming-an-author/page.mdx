...
Fermat is the author whose puzzle goes the longest unsolved, and Fermat can be identified onchain as the owner of the Flag NFT with token ID #0. Anyone can transfer ownership of the token and promote an author to Fermat by calling `setFermat(uint32)` on the [Curta contract](https://etherscan.io/address/0x0000000006bC8D9e5e9d436217B88De704a9F307#writeContract):
