...
<Callout intent="neutral">
  100% of the solve data is [stored onchain](https://etherscan.io/address/0x0000000006bC8D9e5e9d436217B88De704a9F307#readContract), so anyone can make their own leaderboard.
</Callout>
...
<Callout intent="primary">
  You can find the implementation [here](https://github.com/waterfall-mkt/curta.wtf/blob/57d850f4ff1c60ee9f40907c62beccafe9c16d11/lib/utils/fetchLeaderboardPuzzles.ts#L73-L86).
</Callout>
...
<Callout intent="primary">
  You can find the implementation [here](https://github.com/waterfall-mkt/curta.wtf/blob/57d850f4ff1c60ee9f40907c62beccafe9c16d11/lib/utils/fetchLeaderboardPuzzles.ts#L104-L115).
</Callout>
